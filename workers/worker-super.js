...
const authConfig = {
    "siteName": "TS4 Rebels", // Website name
...
const uiConfig = {
    ...
    "favicon": "https://ts4rebels.cc/favicon.ico",
    // if logo is true then link otherwise just text for name
    "logo_link_name": "https://i.ibb.co/WVgNxBD/40.png",
    ...
    "nav_link_4": "Back to TS4 Rebels", // change navigation link name
    ...
    "contact_link": "https://ts4rebels.cc", // Link to Contact Button on Menu
    "copyright_year": "2023", // year of copyright, can be anything like 2015 - 2020 or just 2020
    "company_name": "TS4 Rebels", // Name next to copyright
    "company_link": "https://ts4rebels.cc", // link of copyright name
    ...
    "disable_video_download": true, // Remove Download, Copy Button on Videos
    ...
    "poster": "https://cdn.jsdelivr.net/gh/ts4rebels/vault@main/images/poster.jpg", // Video poster URL or see Readme to how to load from Drive
    "audioposter": "https://cdn.jsdelivr.net/gh/ts4rebels/vault@main/images/music.jpg", // Video poster URL or see Readme to how to load from Drive
    ...
    "unauthorized_owner_link": "https://ts4rebels.cc", // Unauthorized Error Page Link to Owner
    "unauthorized_owner_email": "ts4rebels@pm.me", // Unauthorized Error Page Owner Email
...
<head>
  ...
  <style>body{background-image: none;}a{color:${uiConfig.css_a_tag_color};}p{color:${uiConfig.css_p_tag_color};}</style>
